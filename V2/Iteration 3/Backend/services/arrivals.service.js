...
const db = require("../database/arrivals.db");
...
module.exports.getArrivals = async (line, direction, stopCode) => {
    ...
    return new Promise((resolve, reject) => {
        api.fetchCache(url, {
            fetchDB: () => { return db.getInstance().get(line, direction, stopCode); },
            saveToDb: (result) => { db.getInstance().save(line, direction, stopCode, result); },
